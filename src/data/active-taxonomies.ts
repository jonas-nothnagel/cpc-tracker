...
// is revisited. 2026-07-31: human rights themes added. The upload wizard reads this so users are not asked to
...
export const ACTIVE_TAXONOMIES = ["sector", "globe", "gga", "hr"] as const;
...
// The human rights lens is the nine themes of the UNDP guidance "Human rights
// themes for AI Flagship Policy Coherence Tracker" (DRAFT under expert review).
// Fixed size and not user-curated, so only its count is needed for the estimate.
export const HR_CATEGORY_COUNT = 9;
